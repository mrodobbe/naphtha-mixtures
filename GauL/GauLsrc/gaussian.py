from GauL.GauLsrc.createHistograms import all_values
from GauL.GauLsrc.plots import store_histograms, store_gaussians
import math
import numpy as np
...
def gaussian_mixture_model(geometry_type, values):
    ...
    for i in range(max_iter):
        ...
        ll.append(ll_new)
        print("{} \t Iteration {}/{}: The log-likelihood is {}".format(geometry_type, i+1, max_iter, ll_new))
